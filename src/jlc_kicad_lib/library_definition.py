...
libraries = [
    ...
    LibrarySpec(
        libname="JLCPCB_Basic_Diode-Switching",
        extends_symbol="Device.kicad_symdir/D.kicad_sym",
        package_source=diode_packages,
        name_template="mfg_part",
        value_template="mfg_part",
        category_filter='category="Diodes" and "Subcategory"="Switching Diodes"',
    ),
    LibrarySpec(
        libname="JLCPCB_Basic_Diode-Bridge_Rectifier",
        extends_symbol="Device.kicad_symdir/D.kicad_sym",
        package_source=diode_packages,
        name_template="mfg_part",
        value_template="mfg_part",
        category_filter='category="Diodes" and "Subcategory"="Bridge Rectifiers"',
    ),
    LibrarySpec(
        libname="JLCPCB_Basic_Diode-Fast_Recovery",
        extends_symbol="Device.kicad_symdir/D.kicad_sym",
        package_source=diode_packages,
        name_template="mfg_part",
        value_template="mfg_part",
        category_filter='category="Diodes" and "Subcategory"="Fast Recovery / High Efficiency Diodes"',
    ),
    LibrarySpec(
